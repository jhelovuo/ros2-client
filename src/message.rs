...
impl MessageTypeName {
  ...
  pub fn dds_msg_type(&self) -> String {
    slash_to_colons( self.ros2_package_name.clone() 
      + "/msg/dds_/" + &self.ros2_type_name + "_")
  }

  pub fn dds_request_type(&self) -> String {
    slash_to_colons( self.ros2_package_name.clone() 
      + "/srv/dds_/" + &self.ros2_type_name + "_Request_")
  }

  pub fn dds_response_type(&self) -> String {
    slash_to_colons( self.ros2_package_name.clone() 
      + "/srv/dds_/" + &self.ros2_type_name + "_Response_")
  }

  pub fn dds_action_type(&self) -> String {
    slash_to_colons( self.ros2_package_name.clone() 
      + "/action/dds_/" + &self.ros2_type_name )
  }
}
